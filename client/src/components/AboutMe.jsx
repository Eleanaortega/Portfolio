  ...
  return (
    <div className='aboutme' >
        ...
        <div className='right-about'>
          <div id="name" style={{ fontFamily: 'Bebas Neue', fontSize: '85px' }}>
            <Typed
              strings={[
                "Eleana Ortega"
              ]}
          ...
          <h2 style={{ fontFamily: 'Wish Shore', fontSize: '36px', fontWeight: 'bold', color: 'black' }}>Full-Stack Developer</h2>
              <div className='aboutme-description'>
                <h3>About Me</h3>
                <p style={{fontFamily: 'Avenir', fontSize: '20px', fontWeight: '', color: 'black' }}>
